    ...
    if file_path:
        ...
        if image is not None:
            ...
            if width > max_dimension or height > max_dimension:
                ...
                print(f"Resizing from {width}x{height} to {new_width}x{new_height} to fit boundaries.")
...
cv2.putText(bg, "Webcam", (155, 238), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)

cv2.rectangle(bg, btn_upload_start, btn_upload_end, (200, 0, 0), -1)
cv2.putText(bg, "Upload Image", (365, 238), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 255, 255), 2)
